...
**Se sei un dipendente di Adobe**, puoi contribuire direttamente al [archivio GitHub privato di Adobe](https://git.corp.adobe.com/AdobeDocs/). Per informazioni dettagliate, consulta la Guida all’authoring di Adobe Experience League per i dipendenti di Adobe.
