...
| Usa linea di base | Se è stata creata una baseline per la mappa DITA selezionata, selezionare questa opzione per specificare la versione che si desidera pubblicare.<br><br>**Importante**: quando si genera l&#39;output incrementale per il sito AEM, l&#39;output viene creato utilizzando la versione corrente dei file e non la baseline allegata.<br><br>Visualizzare [Utilizzare la baseline](generate-output-use-baseline-for-publishing.md#id1825FI0J0PF) per ulteriori dettagli. |
...
1. Fai clic su **Aggiungi**. Viene creato il predefinito per AEM Sites.
