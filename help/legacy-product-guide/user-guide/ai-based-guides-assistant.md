...
>[!NOTE]
>
> L&#39;amministratore deve configurare la funzionalità **Assistente Guide**. Per ulteriori dettagli, visualizzare la sezione [Configurare l&#39;Assistente alle guide basate sull&#39;intelligenza artificiale per eseguire ricerche nel contenuto (guida utente)](/help/product-guide/cs-install-guide/conf-guides-assistant.md){target="_blank"} nella Guida all&#39;installazione e alla configurazione per i Cloud Service.
