...
Ad esempio, salvare come `mariadb.json`.


Esempio di file di configurazione per l’autenticazione di base di Elasticsearch:
...
Ad esempio, salvare come `ES.json`.
...
Ad esempio, salvare come `commerce.json`.
