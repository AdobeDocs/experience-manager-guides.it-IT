      ...
      - Servizi cloud {#cloud-release-notes}
         ...
         - Versioni del 2026 {#2026-releases}
            ...
            - Versione 2026.03.0 {#2603-release}
               - [Novità](./release-info/whats-new-2026-03-0.md)
               - [Problemi risolti](./release-info/fixed-issues-2026-03-0.md)
               - [Istruzioni per l&#39;aggiornamento](./release-info/upgrade-instructions-2026-03-0.md)
   ...
   - Gestisci contenuti di apprendimento {#learning-training-content}
      - Guida introduttiva {#get-started}
         - Introduzione {#intro-lc}
            - [Note sulla versione](./release-info-lt/release-notes-lt-2025-12-v2.md)
            - [Note sulla versione](./release-info-lt/release-notes-lt-2026-02-v3.md)
...
- Installazione e configurazione {#install-guide}
   - On-premise {#on-prem-ig}
      ...
      - Impostazioni editor {#editor-configs}
         - [Configura impostazioni editor](./install-guide/editor-settings.md)
      ...
      - Utilizzare le impostazioni di generazione dell’output {#output-gen-config}
         ...
         - [Scaricare e installare modelli AEM Sites](./install-guide/download-install-aem-sites-templates.md)
         - [Mappatura dei componenti per AEM Sites](./install-guide/component-mapping.md)
      ...
      - Utilizzare l’elaborazione delle risorse {#asset-processing-on-prem}
         - [Configura funzionalità di elaborazione risorse](./install-guide/configure-asset-processing.md)
      - Operazioni con la pulizia dell&#39;albero B{#btree-cleanup}
         - [Configurare la pulizia dell&#39;albero B](./install-guide/configure-btree-clean-up-job.md)
      - Indicizzazione personalizzata{#custom-indexing}
         - [Distribuzione dell’indice personalizzato per Trova e sostituisci (visualizzazione Source)](./install-guide/custom-indexing-prem.md)
      - Utilizzare la replica delle risorse DITA{#dita-assets-replication}
         - [Configura replica risorse DITA](./install-guide/configure-dita-asset-replication.md)
   ...
   - Servizi cloud {#cs-ig}
      ...
      - Implementare e configurare AEM Guides as Cloud Service {#deploy-conf-aemg-cs}
         ...
         - [Configurazione aggiuntiva per l’aggiornamento di AEM Guides as Cloud Service](./cs-install-guide/additional-config-for-cloud-service.md)
      ...
      - Utilizzare gli stati dei documenti {#doc-state-cs}
         ...
         - [Configurare i filtri dello stato del documento](./cs-install-guide/config-doc-state-filters.md)
      ...
      - Utilizzare le impostazioni di generazione dell’output {#output-gen-config-cs}
         ...
         - [Scaricare e installare modelli AEM Sites](./cs-install-guide/download-install-aem-sites-templates-cs.md)
         - [Mappatura dei componenti per AEM Sites](./cs-install-guide/component-mapping.md)
      ...
      - Utilizzare l’elaborazione delle risorse {#asset-processing-cloud}
         - [Configurare la funzione di elaborazione delle risorse](./cs-install-guide/configure-asset-processing-cs.md)
      - Operazioni con la pulizia dell&#39;albero B {#btree-cleanup-cs}
         - [Configura pulizia albero B](./cs-install-guide/configure-btree-cleanup-cs.md)
      - Indicizzazione personalizzata {#custom-indexing-cs}
         - [Distribuzione dell&#39;indice personalizzato per Trova e sostituisci (visualizzazione Source)](./cs-install-guide/custom-indexing.md)
      - Utilizzare la replica delle risorse DITA {#dita-assets-replication-cs}
         - [Configura replica risorse DITA](./cs-install-guide/configure-dita-assets-replication.md)
