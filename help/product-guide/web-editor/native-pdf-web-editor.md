...
Per ulteriori informazioni sulla generazione di un PDF utilizzando il metodo DITA-OT, vedere [Genera PDF utilizzando DITA-OT](/help/product-guide/user-guide/generate-output-pdf.md).
...
Per ulteriori informazioni sulla configurazione di FMPS, consulta [Genera output da documenti di FrameMaker](/help/product-guide/user-guide/fm-output-generate.md).
