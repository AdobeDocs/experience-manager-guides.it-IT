...
- [API REST per registrare un connettore di origine dati](data-source-connector.md)
- [API REST per funzionare con gli attributi condizionali](conditional-attribute.md)
- [API REST per il flusso di lavoro di conversione](convert-to-dita.md)
- [API REST per la creazione e l’attivazione dei pacchetti](create-activate-package.md)
- [API basata su Java per lavorare con la generazione di output](generate-output.md)
- [API basate su Java per l&#39;utilizzo delle mappe DITA](dita-map-management-java.md)
- [API basate su Java per il flusso di lavoro di conversione](convert-to-dita-java.md)
