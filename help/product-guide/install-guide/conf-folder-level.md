...
- **Authoring del modello**: utilizzare questa scheda per configurare i modelli che gli autori utilizzeranno per creare contenuti DITA. Sono disponibili i seguenti modelli di argomento predefiniti:
...
- **Predefinito di output**: simile ai modelli di authoring, esistono cinque predefiniti di output preconfigurati:
...
1. Per configurare **Modello di creazione**, vedere [Configurare i modelli di creazione](#id1889D0IL0Y4).
...
1. Per creare o modificare un predefinito di output, effettuate una delle seguenti operazioni:
   ...
   - Fai clic su **Modifica** per aprire la configurazione del predefinito selezionato per la modifica.
     ...
     Per informazioni sulle impostazioni dei predefiniti di output, vedere *Informazioni sui predefiniti di output* in Utilizzo di Adobe Experience Manager Guides.
