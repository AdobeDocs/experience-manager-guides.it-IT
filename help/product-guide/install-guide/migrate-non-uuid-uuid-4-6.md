...
> * Se utilizzi una versione rilasciata prima della versione 4.6.0 Service Pack 4, devi prima eseguire l’aggiornamento alla versione 4.6.0 Service Pack 4. Segui le [istruzioni di aggiornamento](./upgrade-xml-documentation.md) specifiche per la versione con licenza del tuo prodotto.
