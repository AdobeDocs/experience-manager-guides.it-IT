...
Le seguenti schede forniscono istruzioni per la traduzione dei contenuti in base alla configurazione di Experience Manager Guides: Cloud Service o On-Premise.
...
Le schede seguenti forniscono istruzioni per nascondere la scheda Traduzione nel dashboard delle mappe DITA in base alla configurazione di Experience Manager Guides: Cloud Service o On-Premise.
...
L&#39;opzione Nascondi scheda di traduzione non è attivata per impostazione predefinita ed è necessario attivarla da configMgr.
...
Le seguenti schede forniscono istruzioni per il flusso di lavoro di traduzione basato sulla configurazione di Experience Manager Guides: Cloud Service o On-Premise.

>[!BEGINTABS]

>[!TAB Cloud Service]

In base al flusso di lavoro di traduzione utilizzato nella configurazione, deve essere configurata l’opzione del flusso di lavoro di traduzione basato su componenti. Utilizza le istruzioni fornite in [Sostituzioni configurazione](download-install-config-override.md#) per creare il file di configurazione. Nel file di configurazione, fornisci i seguenti dettagli \(property\) per configurare il flusso di lavoro di traduzione basato su componenti:
...
Le schede seguenti forniscono istruzioni per configurare questa opzione in base alla configurazione di Experience Manager Guides: Cloud Service o On-Premise.
...
Utilizza le istruzioni fornite in [Sostituzioni configurazione](download-install-config-override.md#) per creare il file di configurazione. Nel file di configurazione, fornisci i seguenti dettagli (proprietà) per configurare il flusso di lavoro di traduzione legacy:
...
Utilizza le istruzioni fornite in [Sostituzioni configurazione](download-install-config-override.md#) per creare il file di configurazione. Nel file di configurazione, fornisci i seguenti dettagli \(property\) per configurare la post-elaborazione delle copie per lingua temporanee:
...
>[!NOTE]
>
> Per impostazione predefinita, l’opzione di post-elaborazione dei file temporanei è disabilitata.
