...
* La versione di Experience Manager Guides deve essere UUID. Se utilizzi una versione non UUID di Adobe Experience Manager Guides, esegui prima la migrazione a UUID seguendo i passaggi descritti in [Migrare contenuto non DITA](../install-conf-guide/uuid-non-uuid.md).
