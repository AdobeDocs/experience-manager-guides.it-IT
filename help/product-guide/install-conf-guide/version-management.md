...
Nelle schede seguenti vengono fornite istruzioni per configurare le impostazioni per consentire la modifica dei file estratti in base alla configurazione di Experience Manager Guides: Cloud Service o On-Premise.

>[!BEGINTABS]

>[!TAB Cloud Service]

Utilizza le istruzioni fornite in [Sostituzioni configurazione](download-install-config-override.md#) per creare il file di configurazione. Nel file di configurazione, fornire i dettagli \(property\) seguenti per configurare la modifica dei file estratti:
...
Le schede seguenti forniscono istruzioni per consentire agli utenti di sovrascrivere il file in fase di caricamento estratto da loro o da un altro utente in base alla configurazione di Experience Manager Guides: Cloud Service o On-Premise.
...
| PID | Chiave proprietà | Valore proprietà |
|---|------------|--------------|
| `com.adobe.fmdita.config.ConfigManager` | `overwrite.checkout.onupload` | Booleano \(true/false\).<br> **Valore predefinito**: `false` |
...
Le schede seguenti forniscono istruzioni per impedire agli utenti di eliminare accidentalmente i file estratti da loro o da altri utenti in base alla configurazione di Experience Manager Guides: Cloud Service o On-Premise.

>[!BEGINTABS]

>[!TAB Cloud Service]

Utilizza le istruzioni fornite in [Sostituzioni configurazione](download-install-config-override.md#) per creare il file di configurazione. Nel file di configurazione, fornire i seguenti dettagli \(property\) per impedire agli utenti di eliminare accidentalmente i file estratti:
...
Le schede seguenti forniscono istruzioni per definire chi può eliminare un file che contiene riferimenti o a cui fanno riferimento altri file in base alla configurazione di Experience Manager Guides: Cloud Service o On-Premise.

>[!BEGINTABS]

>[!TAB Cloud Service]

Utilizza le istruzioni fornite in [Sostituzioni configurazione](download-install-config-override.md#) per creare il file di configurazione. Nel file di configurazione, fornisci i dettagli \(property\) seguenti per definire chi può eliminare un file che contiene riferimenti o a cui fanno riferimento altri file:
