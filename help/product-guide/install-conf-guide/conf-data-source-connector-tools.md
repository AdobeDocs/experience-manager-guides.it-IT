...
Le schede seguenti forniscono istruzioni per configurare un connettore in base alla configurazione di Experience Manager Guides: Cloud Service o On-Premise.
...
È possibile aggiungere o utilizzare più risorse in base a URL diversi per alcuni connettori, quali ad esempio Generic REST Client, Salsify, Akeneo e Microsoft Azure DevOps Boards (ADO). Quindi, connettiti con loro per creare snippet di contenuto o argomenti utilizzando i generatori per loro.
