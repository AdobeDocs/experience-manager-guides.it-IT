...
Le schede seguenti forniscono istruzioni per aggiungere elementi o attributi DITA personalizzati nel file di serializzazione della ricerca in base alla configurazione di Experience Manager Guides: Cloud Service o On-Premise.
...
Le schede seguenti forniscono istruzioni per abilitare l&#39;opzione di estrazione dei metadati in `configMgr` in base alla configurazione di Experience Manager Guides: Cloud Service o On-Premise.

>[!BEGINTABS]

>[!TAB Cloud Service]

Utilizza le istruzioni fornite in [Sostituzioni configurazione](download-install-config-override.md#) per creare il file di configurazione. Nel file di configurazione, fornisci i seguenti dettagli \(property\) per configurare l’opzione di estrazione dei metadati:
...
Le schede seguenti forniscono istruzioni per escludere la cartella di traduzione temporanea dalla ricerca in base alla configurazione di Experience Manager Guides: Cloud Service o On-Premise.
