...
> * Se utilizzi una versione precedente alla 4.3.1, effettua l’aggiornamento alla versione 4.3.1. Segui le [istruzioni di aggiornamento](./upgrade-aemg-latest-version.md) specifiche per la versione con licenza del tuo prodotto.
