...
Per ulteriori informazioni sui flussi di lavoro in AEM, vedi
...
## Personalizza flusso di lavoro Aggiorna risorsa (solo per on-premise)
...
## Configura flusso di lavoro XML di post-elaborazione (solo per on-premise)
