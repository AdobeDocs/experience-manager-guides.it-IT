---
title: Note sulla versione | Istruzioni per l’aggiornamento a Adobe Experience Manager Guides 5.0.0 Service Pack 3
description: Scopri la matrice di compatibilità e come effettuare l’aggiornamento alla versione 5.0.0 Service Pack 3 di Adobe Experience Manager Guides.
...
# Istruzioni per l’aggiornamento alla versione 5.0.0 Service Pack 3 (febbraio 2026)

Questo articolo descrive le istruzioni per l’aggiornamento e la matrice di compatibilità per la versione 5.0.0 Service Pack 3 di Adobe Experience Manager Guides.

Per l&#39;elenco dei problemi risolti in questa versione, visualizzare [Problemi risolti nella versione 5.0.0 Service Pack 3](../release-info/fixed-issues-5-0-0-sp3.md).

## Matrice di compatibilità

In questa sezione viene elencata la matrice di compatibilità per le applicazioni software supportate da Experience Manager Guides 5.0.0 Service Pack 3 release.
...
| Versione | FMPS | FM |
| --- | --- | --- |
| 5.0.0 Service Pack 3 (UUID) | Funzione supportata | 2022 o versione successiva |
...
## Aggiornamento alla versione 5.0.0 Service Pack 3 di Experience Manager Guides

È possibile aggiornare facilmente la versione corrente delle Guide alla versione 5.0.0 Service Pack 3. Prima di procedere all’aggiornamento alla versione 5.0.0 Service Pack 3 di Experience Manager Guides, è necessario considerare i seguenti punti:

- Se utilizzi le versioni 5.0.0 Service Pack 2, 5.0.0 Service Pack 1 o 5.0.0, puoi eseguire direttamente l’aggiornamento alla versione 5.0.0 Service Pack 3.
