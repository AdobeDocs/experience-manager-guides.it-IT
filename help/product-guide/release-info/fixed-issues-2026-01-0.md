---
title: Note sulla versione | Problemi risolti in Adobe Experience Manager Guides, versione 2026.01.0
...
- Quando si inserisce un rimando a un file, le icone per le mappe e gli argomenti sono identiche.(GUIDES-36662)
