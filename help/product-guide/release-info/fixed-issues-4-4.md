---
title: Note sulla versione | Sono stati risolti i problemi relativi alla versione 4.4.0 delle Guide di Adobe Experience Manager
description: Scopri le correzioni di bug nella versione 4.4.0 delle guide di Adobe Experience Manager
role: Leader
...
Questo articolo descrive i bug corretti in varie aree della versione 4.4.0 delle Guide di Adobe Experience Manager.

Per ulteriori informazioni sulle nuove funzioni e sui miglioramenti, vedi [Novità della versione 4.4.0](./whats-new-4-4.md).
