---
title: Note sulla versione | Istruzioni per l’aggiornamento e problemi risolti in Adobe Experience Manager Guides, versione 2026.09.0
description: Scopri la matrice di compatibilità e come effettuare l’aggiornamento alla versione 2026.09.0 di Adobe Experience Manager Guides as a Cloud Service.
source-git-commit: c3c72732237f937fef0213afbbd7f20cc1d9ee65
workflow-type: tm+mt
source-wordcount: '417'
ht-degree: 1%
---
# Istruzioni per l’aggiornamento alla versione 2026.09.0

Questo articolo descrive le istruzioni per l’aggiornamento e la matrice di compatibilità per la versione 2026.09.0 di Adobe Experience Manager Guides as a Cloud Service.
...
Questa sezione descrive la matrice di compatibilità per le applicazioni software supportate dalla versione 2026.09.0 di Experience Manager Guides as a Cloud Service.
...
|---|---|---|----|
| 2026.09.0 | 2026.9.0 | [API SDK AEM Guides 2026.9.0](https://central.sonatype.com/artifact/com.adobe.aem/aem-dox-sdk-api/2026.9.0) | [Javadoc 2026.9.0](https://javadoc.io/doc/com.adobe.aem/aem-dox-sdk-api/latest/index.html) |
...
| --- | --- | --- | --- |
| 2026.09.0 | Non compatibile | 2022 o versione successiva | 26.1 |
...
| --- | --- | --- | --- | --- |
| 2026.09.0 | 3,8-uuid 1 | 3,8-uuid 1 | 2,3 | 2,3 |
...
## Aggiornamento alla versione 2026.09.0
