...
* La funzionalità **Inserisci parola chiave** è stata migliorata. È ora possibile trovare più facilmente una parola chiave da inserire poiché le parole chiave sono elencate in ordine alfabetico. È inoltre possibile cercare le parole chiave digitando una stringa di ricerca nella casella Cerca.
...
Per ulteriori dettagli sulla traduzione, vedere *Tradurre documenti dalla sezione Editor Web* in Utilizzo di Adobe Experience Manager Guides as a Cloud Service.
...
* Il pulsante Chiudi non viene visualizzato quando la casella di controllo **Salva come nuova versione** è abilitata. (9637)
...
* Lo stato dei filtri per attributi condizionali non viene mantenuto quando si passa da Anteprima a Source e si torna alla modalità Anteprima. (9553)
* Se non viene specificato alcun nome tramite il tag `mainbooktitle`, il nome della mappa di registro verrà vuoto nella visualizzazione Archivio. (9538)
...
* Impossibile visualizzare tutti i `glossrefs` nel pannello Glossario (contenuto specifico). (8886)
