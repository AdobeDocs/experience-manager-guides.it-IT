---
title: Note sulla versione | Istruzioni per l’aggiornamento e problemi risolti in Adobe Experience Manager Guides, versione 2024.12.0
description: Scopri la matrice di compatibilità e come effettuare l’aggiornamento alla versione 2024.12.0 di Adobe Experience Manager Guides as a Cloud Service.
...
# Istruzioni per l’aggiornamento alla versione 2024.12.0

Questo articolo descrive le istruzioni per l’aggiornamento e la matrice di compatibilità per la versione 2024.12.0 di Adobe Experience Manager Guides as a Cloud Service.

Per un elenco dei problemi risolti in questa versione, consulta [Problemi risolti nella versione 2024.12.0](fixed-issues-2024-12-0.md).

## Matrice di compatibilità

In questa sezione è elencata la matrice di compatibilità per le applicazioni software supportate dalla versione 2024.12.0 di Experience Manager Guides as a Cloud Service.

### FRAMEMAKER e FRAMEMAKER PUBLISHING SERVER

| Versione di Experience Manager Guides as a Cloud | FMPS | FrameMaker |
| --- | --- | --- |
| 2024.12.0 | Non compatibile | 2022 o versione successiva |
| | | |
...
### Nuova versione del modello AEM Sites

| Versione componenti | Versione di Sites |
|---|---|
| guides-components.all-1.0.0 | daemg-sites-template-1.0.0 |

## Aggiornamento alla versione 2024.12.0
