...
Per l&#39;elenco dei problemi risolti in questa versione, visualizzare [Problemi risolti nella versione 5.1.0 Service Pack 4](../release-info/fixed-issues-5-1-0-sp4.md).

## Matrice di compatibilità

In questa sezione viene elencata la matrice di compatibilità per le applicazioni software supportate da Experience Manager Guides 5.1.0 Service Pack 4 release.
...
| Versione | FMPS | FM |
| --- | --- | --- |
| 5.1.0 Service Pack 4 (UUID) | Funzione supportata | 2022 o versione successiva |
...
## Aggiornamento alla versione 5.1.0 Service Pack 4 di Experience Manager Guides

Puoi aggiornare facilmente la versione corrente di Experience Manager Guides alla versione 5.1.0 Service Pack 4 in **AEM 6.5** o **AEM 6.5 LTS**.
...
- Se utilizzi la versione 5.1.0 o 5.1.x, puoi eseguire direttamente l’aggiornamento alla versione 5.1.0 Service Pack 4.
