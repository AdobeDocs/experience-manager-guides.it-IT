...
Utilizzando il connettore AEM in FrameMaker, puoi gestire i file di FrameMaker. Il connettore AEM consente di caricare facilmente il DITA e altri documenti di FrameMaker (con estensione book e fm) sull’AEM. AEM Guides consente inoltre di pubblicare documenti di FrameMaker direttamente dall’AEM. Nel caso in cui il file del manuale del FrameMaker contenga una combinazione di file DITA e fm, AEM Guides può pubblicare anche tali documenti. Attualmente, è possibile pubblicare i file .book e .fm di FrameMaker nei formati PDF, HTML5 e EPUB.
