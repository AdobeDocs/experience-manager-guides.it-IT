...
Nel pannello Repository, apri il file di mappa DITA in **Vista mappa**, quindi nella scheda **Output** seleziona l&#39;icona + per creare un predefinito di output, quindi seleziona **Knowledge Base** dal menu a discesa **Tipo** nella finestra di dialogo **Nuovo predefinito di output**. Puoi denominare il predefinito e scegliere la destinazione per generare l&#39;output utilizzando **Adobe Experience Manager**, **Salesforce** o **ServiceNow**.
...
>[!NOTE]
>
>È possibile utilizzare il predefinito della Knowledge Base di Adobe Experience Manager se è stato configurato dall&#39;amministratore. Per ulteriori dettagli, visualizzare [Pubblicazione basata su articolo dalla sezione Web Editor](../install-guide/configure-article-based-publishing.md) nella Guida all&#39;installazione e alla configurazione.
