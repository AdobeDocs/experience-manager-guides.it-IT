...
Per l&#39;elenco dei problemi risolti in questa versione, visualizzare [Problemi risolti nella versione 5.0.0](/help/product-guide/release-info/fixed-issues-5-0-0.md).
...
Per ulteriori dettagli, consulta la sezione [Requisiti tecnici](/help/product-guide/install-guide/download-install-technical-requirements.md) nella Guida all&#39;installazione e alla configurazione on-premise.
...
Per informazioni dettagliate, visualizzare [Istruzioni per l&#39;aggiornamento per le versioni locali](/help/product-guide/install-guide/upgrade-xml-documentation.md) di Experience Manager Guides.
