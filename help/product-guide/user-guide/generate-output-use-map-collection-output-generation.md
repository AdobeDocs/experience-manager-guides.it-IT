...
In qualsiasi organizzazione, un prodotto può avere più tipi di documentazione. In qualità di specialista della pubblicazione, desideri controllare l’output che desideri generare per ciascun documento. Inoltre, dovrebbe essere possibile pubblicare più documenti in batch in un unico passaggio.

Adobe Experience Manager Guides consente di organizzare i contenuti da pubblicare tramite un dashboard denominato Raccolta mappe. Una raccolta di mappe consente di assemblare tutti i diversi tipi di documenti in un&#39;unica unità. È possibile scegliere il tipo di output che si desidera generare per ciascun documento nella raccolta di mappe. Inoltre, puoi anche generare l’output e visualizzare l’avanzamento della generazione dell’output dal dashboard di pubblicazione.

Raccolta mappe consente di visualizzare eventuali modifiche apportate a una mappa rispetto all’ultimo output pubblicato. Puoi visualizzare i dettagli nella scheda Mappe e predefiniti della raccolta mappe e quindi ripubblicare l’output se necessario.
...
1. Apri la [home page di Experience Manager Guides](./intro-home-page.md#map-collections) e seleziona **Mappa raccolte**.

   La pagina **Mappa raccolte** viene aperta in una nuova scheda.

   ![](images/map-collections-page.png){width="350"}

   >[!NOTE]
   >
   > Puoi anche aprire l&#39;interfaccia utente di Assets e selezionare **Mappa raccolte**. Se la pagina Mappa raccolte non è disponibile, seleziona l&#39;opzione **Navigazione** nella barra a sinistra, quindi seleziona **Mappa raccolte**.

1. Nella pagina **Mappa raccolte**, seleziona **Crea** in alto a destra e fornisci un **Titolo raccolta** per la raccolta mappe.
1. Seleziona **Crea**.

   Al momento della creazione della raccolta di mappe viene visualizzato un messaggio di operazione riuscita.

1. Seleziona **Chiudi** nel messaggio di successo.

   Il file di mappa appena creato viene visualizzato nella pagina Mappa raccolte.

1. Seleziona la casella grigia nella sezione della raccolta che desideri modificare.
1. La raccolta di mappe selezionata viene aperta nel dashboard della raccolta di mappe.
...
1. Seleziona **Fine**.
   ...
   ![mappa dashboard raccolta](./images/map-collection-dashboard.png)
...
1. Apri la raccolta di mappe. Puoi visualizzare i vari predefiniti di output come AEM Sites, PDF (incluso Native PDF), HTML5, EPUB e Predefiniti personalizzati. Puoi anche visualizzare i predefiniti per i profili globali e delle cartelle creati dall’amministratore.
...
1. \(Facoltativo\) Effettuare una delle seguenti operazioni in base alle proprie esigenze:
   ...
   - Se necessario, selezionare **Modifica** e modificare l&#39;output desiderato attivando o disattivando il pulsante scorrevole.
...
![modifica una raccolta mappe in servizi cloud](images/edit-map-collection-cs.png)



1. Effettua una delle seguenti operazioni:

   - Per generare l&#39;output delle mappe selezionate, selezionare i file di mappa e selezionare **Genera selezionati**.
   - Per generare l&#39;output di tutte le mappe DITA con i relativi predefiniti configurati, selezionare **Genera tutto**.
...
- Per eliminare una raccolta mappe, selezionare una raccolta nella pagina Raccolta mappe e selezionare **Elimina**.
- Per eliminare una mappa DITA da una raccolta mappe, aprire la raccolta mappe in modalità Modifica, selezionare il file di mappa DITA e selezionare **Rimuovi da raccolta**.
