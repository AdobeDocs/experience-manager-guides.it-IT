...
>[!NOTE]
>
> A partire dalla versione **2026.09.0** di Experience Manager Guides as a Cloud Service, il pulsante **Contrassegna come completato** viene rinominato **Attività di revisione completa**, insieme a funzioni aggiuntive nell&#39;interfaccia utente di revisione per consentire ai revisori di tenere traccia dello stato di avanzamento della revisione. Per ulteriori dettagli, visualizza [Contrassegna singoli argomenti come completati](review-topics.md#mark-individual-topics-as-done-in-a-review-task). I passaggi per completare un&#39;attività di revisione rimangono gli stessi.
