...
description: Scopri come creare un predefinito in EPUB dal dashboard delle mappe. Configura il predefinito di output EPUB nelle guide AEM.
...
| Nome impostazione | Assegna un nome descrittivo alle impostazioni di output in EPUB che stai creando. Ad esempio, puoi specificare _Output clienti interni_ o _output degli utenti finali_. |
