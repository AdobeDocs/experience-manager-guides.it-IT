...
![finestra di dialogo filtro avanzato](images/repository-filter-search-advanced.png) {width="650"}
...
![Menu Opzioni nella vista Mappa](images/options-menu-map-view_cs.png)
